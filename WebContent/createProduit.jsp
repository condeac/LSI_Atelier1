...
<body>
	<div class="limiter">
		<div class="container-login100">
			<form action="CreateServlet" method="post" class="login100-form validate-form" enctype="multipart/form-data">
				<span class="login100-form-title" style="font-size: 40px; color: white;">Nouveau Produit</span>
